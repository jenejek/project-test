...
exports.config = {
     ...
     */
    onPrepare: async () => console.log('Run tests!'),
...
//
    ...
    afterTest: async (tests, context, { error }) => {

        let currentUrl = await browser.getUrl();

        await allure.addAttachment(
            'Info',
            `Browser Name - ${browser.capabilities.browserName},\nPlatform Name - ${browser.capabilities.platformName}, \nURL - ${currentUrl}`,
            'text/json'
        );
        ...
        if (error !== undefined) {
            ...
            await allure.endStep('failed', {error});
        }
    },
    /**
